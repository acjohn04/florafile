export const en = {
  ...
  settings: {
    ...
    climateDesc: "Enter your ZIP code to get a hardiness zone for your plants. This helps the AI tailor care instructions.",
    zipCodeLabel: "ZIP Code",
    zipCodePlaceholder: "e.g. 94103",
    zipCodeButton: "Save",
    zipCodeSaving: "Saving...",
    hardinessZoneLabel: "Hardiness Zone",
    hardinessError: "Failed to determine hardiness zone",
    
    roomsTitle: "Manage Rooms",
    roomsDesc: "Customize the list of rooms where your plants live.",
    addRoomPlaceholder: "New room name",
    addRoomButton: "Add",
    deleteRoomButton: "Delete",
    saveRoomButton: "Save",
    cancelRoomButton: "Cancel",
